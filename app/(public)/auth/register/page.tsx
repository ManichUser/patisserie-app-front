        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-gray-600">
              Rejoignez-nous pour une expérience gourmande
            </p>
          </div>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/terms" className="text-primary-950 hover:underline">
              Conditions d'utilisation
            </Link>{' '}
            et notre{' '}
            <Link href="/privacy" className="text-primary-950 hover:underline">
          ...
          <p className="text-center text-gray-600">
            ...
            <Link href={ROUTES.LOGIN} className="text-primary-950 font-semibold hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
